class DeletePilot extends HTMLElement {
    ...
    connectedCallback(){
        ...
        <div class="formDelete">
            <form id="myformDeletePilot">
                ...
                <input type="text" id="pilotId" name="id" required>

                <label for="pilotName">Name</label>
                <input type="text" id="pilotName" name="name" disabled>
    ...
    this.querySelector("#teamDelete").addEventListener("input", async (e) => {
      ...
      this.querySelector("#myformDeletePilot").addEventListener(
        "submit",
        async (e) => {
          e.preventDefault();
